...
@NgModule({
  ...
  providers: [FiLinkModalService, TimerSelectorService, Download, ImageViewService,
    ...
    MenuSearchService, SelectGroupService, FacilityShowService, IndexCardControlService, CloseShowFacilityService, AlarmTurnTroubleService, WebUploadService, PositionService,
