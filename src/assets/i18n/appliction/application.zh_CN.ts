export default {
  ...
  strategyList: {
    ...
    hasEnableData: '所选策略有已启用状态，请重新选择',
    hasDisableData: '所选策略有已禁用状态，请重新选择',
    editInfo: '无法编辑启用状态的策略！'
  },
  // 内容列表
  contentList: {
    programName: '节目名称',
  ...
  reportAnalysis: {
    ...
    electricityConsumption: '用电量(kw·h)',
    ...
    summaryGraph: '统计图',
    inputCurrent: '输入电流 (A)',
    minInputCurrent: '最小输入电流 (A)',
    maxInputCurrent: '最大输入电流 (A)',
    ...
    // AB相电压有效值(V)
    abEffectiveValueOfVoltage: 'AB线电压 (V)',
    // BC相电压有效值(V)
    bcEffectiveValueOfVoltage: 'BC线电压 (V)',
    // CA相电压有效值(V)
    caEffectiveValueOfVoltage: 'CA线电压 (V)',
    // 最小A相电压有效值
    minAEffectiveValueOfVoltage: '最小A相电压有效值 (V)',
    // 最大A相电压有效值
    maxAEffectiveValueOfVoltage: '最大A相电压有效值 (V)',
    // 最小B相电压有效值
    minBEffectiveValueOfVoltage: '最小B相电压有效值 (V)',
    // 最大B相电压有效值
    maxBEffectiveValueOfVoltage: '最大B相电压有效值 (V)',
    // 最小C相电压有效值
    minCEffectiveValueOfVoltage: '最小C相电压有效值 (V)',
    // 最大C相电压有效值
    maxCEffectiveValueOfVoltage: '最大C相电压有效值 (V)',
    // 最小AB线电压
    minABEffectiveValueOfVoltage: '最小AB线电压 (V)',
    // 最大AB线电压
    maxABEffectiveValueOfVoltage: '最大AB线电压 (V)',
    // 最小BC线电压
    minBCEffectiveValueOfVoltage: '最小BC线电压 (V)',
    // 最大BC线电压
    maxBCEffectiveValueOfVoltage: '最大BC线电压 (V)',
    // 最小CA线电压
    minCAEffectiveValueOfVoltage: '最小CA线电压 (V)',
    // 最大CA线电压
    maxCAEffectiveValueOfVoltage: '最大CA线电压 (V)',
    // 功率
    power: '功率 (kw)',
    // 最小功率
    minPower: '最小功率 (kw)',
    ...
    maxPower: '最大功率 (kw)',
    // 瞬时总有功功率
    activePower: '瞬时总有功功率 (kw)',
    // 瞬时A相有功功率
    aActivePower: '瞬时A相有功功率 (kw)',
    // 瞬时B相有功功率
    bActivePower: '瞬时B相有功功率 (kw)',
    // 瞬时C相有功功率
    cActivePower: '瞬时C相有功功率 (kw)',
    // 瞬时总无功功率
    reactivePower: '瞬时总无功功率 (kw)',
    // 瞬时A相无功功率
    aReactivePower: '瞬时A相无功功率 (kw)',
    // 瞬时B相无功功率
    bReactivePower: '瞬时B相无功功率 (kw)',
    // 瞬时C相无功功率
    cReactivePower: '瞬时C相无功功率 (kw)',
    // 最小瞬时总有功功率
    minActivePower: '最小瞬时总有功功率 (kw)',
    // 最大瞬时总有功功率
    maxActivePower: '最大瞬时总有功功率 (kw)',
    // 最小瞬时A相有相功率 (kw)
    minAActivePower: '最小瞬时A相有相功率 (kw)',
    // 最大瞬时A相有相功率(kw)
    maxAActivePower: '最大瞬时A相有相功率 (kw)',
    // 最小瞬时B相有功功率
    minBActivePower: '最小瞬时B相有功功率 (kw)',
    // 最大瞬时B相有功功率
    maxBActivePower: '最大瞬时B相有功功率 (kw)',
    // 最小瞬时C相有功功率
    minCActivePower: '最小瞬时C相有功功率 (kw)',
    // 最大瞬时C相有功功率
    maxCActivePower: '最大瞬时C相有功功率 (kw)',
    // 最小瞬时总无功功率
    minReactivePower: '最小瞬时总无功功率 (kw)',
    // 最大瞬时总无功功率
    maxReactivePower: '最大瞬时总无功功率 (kw)',
    // 最小瞬时A相无功功率
    minAReactivePower: '最小瞬时A相无功功率 (kw)',
    // 最小瞬时A相无功功率
    maxAReactivePower: '最大瞬时A相无功功率 (kw)',
    // 最小瞬时B相无功功率
    minBReactivePower: '最小瞬时B相无功功率 (kw)',
    // 最大瞬时B相无功功率
    maxBReactivePower: '最大瞬时B相无功功率 (kw)',
    // 最小瞬时C相无功功率
    minCReactivePower: '最小瞬时C相无功功率 (kw)',
    // 最大瞬时C相无功功率
    maxCReactivePower: '最大瞬时C相无功功率 (kw)',
    // 电能
    energy: '电能 (kw·h)',
    // 总相正向有功电能量
    activeElectricEnergy: '总相正向有功电能量 (kw·h)',
    // A相正向有功电能量
    aActiveElectricEnergy: 'A相正向有功电能量 (kw·h)',
    // B相正向有功电能量
    bActiveElectricEnergy: 'B相正向有功电能量 (kw·h)',
    // C相正向有功电能量
    CActiveElectricEnergy: 'C相正向有功电能量 (kw·h)',
    // 总正向无功电能量
    reactiveEnergy: '总正向无功电能量 (kw·h)',
    // A相正向无功电能量
    aReactiveEnergy: 'A相正向无功电能量 (kw·h)',
    // B相正向无功电能量
    BReactiveEnergy: 'B相正向无功电能量 (kw·h)',
    // C相正向无功电能量
    CReactiveEnergy: 'C相正向无功电能量 (kw·h)',
    // 瞬时总相功率因数
